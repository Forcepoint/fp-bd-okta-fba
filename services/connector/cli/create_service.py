#
# functionality: class for creating okta_connector.service systemd service
# Author:  Dlo Bagari
...
class CreateService:
    ...
    def _create_service(self, name):
        service = """
[Unit]
Description=Connects risk level publisher with risk level consumer
Wants=network-online.target
After=network.target network-online.target

[Service]
ExecStart={}/scripts/connector_service.sh run -c {}
